 ...
 *  水印DOM id
 */
const WATER_MARK_DOM_ID = 'more_focus_water_mark';
let moreFocusWaterMarkIntervalId = null;
...
const watermark = {
    ...
    set: function (id, str) {
        ...
        //每隔1分钟检查一次水印
        moreFocusWaterMarkIntervalId = setInterval(() => {
            setWatermark(id, str);
        }, 60000);
    ...
    clear: function () {
        ...
        if (moreFocusWaterMarkIntervalId) {
            clearInterval(moreFocusWaterMarkIntervalId);
            moreFocusWaterMarkIntervalId = null;
        }
    },
};
